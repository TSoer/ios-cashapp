...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([segue.identifier isEqualToString:@"editusertowelcome_segue"]) {
        WelcomeViewController *WelcomeVC;
        WelcomeVC = [segue destinationViewController];
    } else if([segue.identifier isEqualToString:@"editusertoeditscreen_segue"]) {
...
- (IBAction)logoutButtonAction:(id)sender {
    [self performSegueWithIdentifier:@"editusertowelcome_segue" sender:self];
}
